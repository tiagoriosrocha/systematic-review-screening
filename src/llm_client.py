            ...
            try:
                ...
                response = self.client.chat.completions.create(
                    ...
                    messages=[
                        {
                            "role": "system",
                            "content": "You are an expert in evaluating scientific articles for systematic literature reviews. You must respond exclusively in valid JSON format without any markdown code blocks or additional text."
                        },
